...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\medHeartV2\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\medHeartV2\\public\\storage','logging.default','logging.deprecations.channel',
...
'session.partitioned','sweetalert.theme','sweetalert.cdn','sweetalert.alwaysLoadJS','sweetalert.neverLoadJS',
'sweetalert.timer','sweetalert.width','sweetalert.height_auto','sweetalert.padding','sweetalert.background',
'sweetalert.animation.enable','sweetalert.animatecss','sweetalert.show_confirm_button','sweetalert.show_close_button','sweetalert.button_text.confirm',
'sweetalert.button_text.cancel','sweetalert.toast_position','sweetalert.timer_progress_bar','sweetalert.middleware.autoClose','sweetalert.middleware.toast_position',
'sweetalert.middleware.toast_close_button','sweetalert.middleware.timer','sweetalert.middleware.auto_display_error_messages','sweetalert.customClass.container','sweetalert.customClass.popup',
...
'sweetalert.confirm_delete_show_cancel_button','sweetalert.confirm_delete_show_close_button','sweetalert.confirm_delete_icon','sweetalert.confirm_delete_show_loader_on_confirm','broadcasting.default',
...
'web','api',);
        registerArgumentsSet('routes', 'Connection à MedHeart','Récuperation de compte','recuperation_compte_controller.store','recuperation_compte_controller.index',
'recuperation_compte_controller.create','recuperation_compte_controller.show','recuperation_compte_controller.edit','recuperation_compte_controller.update','recuperation_compte_controller.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'components.page_layout_connection','components.toast','login','recuperation_compte','sweetalert::alert',
'vendor.sweetalert.alert','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
