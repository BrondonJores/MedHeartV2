...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereMatricule($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereNom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins wherePrenom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereAge($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereSexe($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereAdresse($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereTelephone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereIdSpecialite($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereIdService($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Medecins>|Medecins query()
     ...
     */
    class Medecins extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property string $matricule
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereMatricule($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereNom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients wherePrenom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereAge($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereSexe($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereAdresse($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereTelephone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Patients>|Patients query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
